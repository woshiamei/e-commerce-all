...
class BQ_Client(object):
    def __init__(self):
        # self.client = bigquery.Client.from_service_account_json(os.getcwd()+os.sep+'utils'+os.sep+AUTH_JSON_FILE_PATH)
...
# print('1')
#
# res1 = requests.get('https://www.youtubu.com')
