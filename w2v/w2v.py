...
if __name__ == '__main__':
    ...
    file_sample = "../data/w2v_samples_{}.csv".format(cur_time)
    ...
    model = Word2Vec(samples, vector_size=64, min_count=1, sg=0, window=3, workers=4, negative=5, epochs=10)

    print(model.wv.similarity(3873, 3459))
    model.save('./model/w2v_{}.model'.format(cur_time))

    model1 = Word2Vec.load('./model/w2v_{}.model'.format(cur_time))
    ...
    w2v_res_file = '../data/w2v_res_{}.csv'.format(cur_time)
